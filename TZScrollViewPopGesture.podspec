Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/banchichen/TZScrollViewPopGesture.git", :tag => "1.0.0" }
  s.requires_arc = true
  s.resources    = "TZScrollViewPopGesture/TZScrollViewPopGesture/*.{png,xib,nib,bundle}"
